...
def evaluate(config):
    ...
    def cfg_nnet(x, timesteps, encoder_hidden_states):
        ...
        _cond = nnet(x, timesteps, encoder_hidden_states=encoder_hidden_states)
        ...
        _uncond = nnet(x, timesteps, encoder_hidden_states=_empty_context)
    ...
    def sample_fn(_n_samples):
        ...
        return dpm_solver_sample(_n_samples, config.sample.sample_steps, encoder_hidden_states=_context)
